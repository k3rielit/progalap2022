        ...
        for(int c=0; c<8; c++) {
            if(tabla[r][c]=='K') {
                for(int kr=r-1; kr>=0; kr--) {
                    if(tabla[kr][c]!='U' && tabla[kr][c]!='B') break;
                    else if(tabla[kr][c]=='B') {
                        *utniKepesBastyak+=1;
                        break;
                    }
                }
                for(int kr=r+1; kr<8; kr++) {
                    if(tabla[kr][c]!='U' && tabla[kr][c]!='B') break;
                    else if(tabla[kr][c]=='B') {
                        *utniKepesBastyak+=1;
                        break;
                ...
                for(int kc=c-1; kc>=0; kc--) {
                    if(tabla[r][kc]!='U' && tabla[r][kc]!='B') break;
                    else if(tabla[r][kc]=='B') {
                        *utniKepesBastyak+=1;
                        break;
                    }
                }
                for(int kc=c+1; kc<8; kc++) {
                    if(tabla[r][kc]!='U' && tabla[r][kc]!='B') break;
                    else if(tabla[r][kc]=='B') {
                        *utniKepesBastyak+=1;
                        break;
